 ...
 * @category generated
 */
export var updateAdminStruct = new beet.BeetArgsStruct([
    ['instructionDiscriminator', beet.uniformFixedSizeArray(beet.u8, 8)],
    ['newAdmin', beetSolana.publicKey],
], 'UpdateAdminInstructionArgs');
export var updateAdminInstructionDiscriminator = [
 ...
 * @category generated
 */
export function createUpdateAdminInstruction(accounts, args, programId) {
    var _a, _b;
    if (programId === void 0) { programId = new web3.PublicKey('2HLsq8QGhRnUUwuukCKLNdpvNc4utW6AQVV1VoY9jgEd'); }
    var data = updateAdminStruct.serialize(__assign({ instructionDiscriminator: updateAdminInstructionDiscriminator }, args))[0];
    var keys = [
        {
