 ...
 * @category generated
 */
export var addCollectionStruct = new beet.BeetArgsStruct([
...
export var addCollectionInstructionDiscriminator = [
 ...
 * @category generated
 */
export function createAddCollectionInstruction(accounts, args, programId) {
    var _a, _b;
    if (programId === void 0) { programId = new web3.PublicKey('2HLsq8QGhRnUUwuukCKLNdpvNc4utW6AQVV1VoY9jgEd'); }
    var data = addCollectionStruct.serialize(__assign({ instructionDiscriminator: addCollectionInstructionDiscriminator }, args))[0];
    var keys = [
        {
