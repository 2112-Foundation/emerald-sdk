 ...
 * @category generated
 */
export var initialiseMainStruct = new beet.BeetArgsStruct([
...
export var initialiseMainInstructionDiscriminator = [
 ...
 * @category generated
 */
export function createInitialiseMainInstruction(accounts, args, programId) {
    var _a, _b;
    if (programId === void 0) { programId = new web3.PublicKey('2HLsq8QGhRnUUwuukCKLNdpvNc4utW6AQVV1VoY9jgEd'); }
    var data = initialiseMainStruct.serialize(__assign({ instructionDiscriminator: initialiseMainInstructionDiscriminator }, args))[0];
    var keys = [
        {
