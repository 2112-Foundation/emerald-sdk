 ...
 * @category generated
 */
export var initialiseUserCommunityAccountStruct = new beet.BeetArgsStruct([
    ['instructionDiscriminator', beet.uniformFixedSizeArray(beet.u8, 8)],
    ['communityIdx', beet.u32],
], 'InitialiseUserCommunityAccountInstructionArgs');
export var initialiseUserCommunityAccountInstructionDiscriminator = [
 ...
 * @category generated
 */
export function createInitialiseUserCommunityAccountInstruction(accounts, args, programId) {
    var _a, _b;
    if (programId === void 0) { programId = new web3.PublicKey('2HLsq8QGhRnUUwuukCKLNdpvNc4utW6AQVV1VoY9jgEd'); }
    var data = initialiseUserCommunityAccountStruct.serialize(__assign({ instructionDiscriminator: initialiseUserCommunityAccountInstructionDiscriminator }, args))[0];
    var keys = [
        {
