...
export var snapshotPegDiscriminator = [184, 82, 26, 64, 104, 23, 219, 118];
/**
 ...
 * @category generated
 */
var SnapshotPeg = /** @class */ (function () {
    function SnapshotPeg(userCommunityAccount, userKey) {
        this.userCommunityAccount = userCommunityAccount;
        this.userKey = userKey;
    }
    /**
     * Creates a {@link SnapshotPeg} instance from the provided args.
     */
    SnapshotPeg.fromArgs = function (args) {
     ...
     */
    SnapshotPeg.fromAccountInfo = function (accountInfo, offset) {
     ...
     */
    SnapshotPeg.fromAccountAddress = function (connection, address, commitmentOrConfig) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        accountInfo = _a.sent();
                        if (accountInfo == null) {
                            throw new Error("Unable to find SnapshotPeg account at ".concat(address));
                        }
                        return [2 /*return*/, SnapshotPeg.fromAccountInfo(accountInfo, 0)[0]];
                }
            });
        });
    };
     ...
     */
    SnapshotPeg.gpaBuilder = function (programId) {
     ...
     * @returns a tuple of the account data and the offset up to which the buffer was read to obtain it.
     */
    SnapshotPeg.deserialize = function (buf, offset) {
        if (offset === void 0) { offset = 0; }
     ...
     */
    SnapshotPeg.prototype.serialize = function () {
        return snapshotPegBeet.serialize(__assign({ accountDiscriminator: snapshotPegDiscriminator }, this));
    };
    Object.defineProperty(SnapshotPeg, "byteSize", {
        /**
     ...
     */
    SnapshotPeg.getMinimumBalanceForRentExemption = function (connection, commitment) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, connection.getMinimumBalanceForRentExemption(SnapshotPeg.byteSize, commitment)];
            });
        });
    };
    /**
     ...
     */
    SnapshotPeg.hasCorrectByteSize = function (buf, offset) {
        if (offset === void 0) { offset = 0; }
     ...
     */
    SnapshotPeg.prototype.pretty = function () {
        return {
